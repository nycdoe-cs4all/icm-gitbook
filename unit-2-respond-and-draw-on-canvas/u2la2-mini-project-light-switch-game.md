...
3. Create a p5 program where each switch turns a combination of lights on and/or off. **Utilize an object to store the colors (or whatever property you are changing) for all of the lights!**&#x20;
